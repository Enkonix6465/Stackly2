...
export default function EmailMarketingAutomation({ darkTheme, setDarkTheme }) {
    return (
        <>
            ...
            <section className={`w-full py-16 flex flex-col items-center ${darkTheme ? 'bg-black' : 'bg-white'}`}>
                <div className="w-full max-w-6xl flex flex-col md:flex-row items-center gap-12 px-4">
                    ...
                    <div className="md:w-1/2 w-full flex justify-center items-center mb-8 md:mb-0 min-h-[350px]">
                        <img 
                            src={email1Img} 
                            alt="Why Email Marketing & Automation" 
                    ...
                    <div className="md:w-1/2 w-full flex flex-col items-start">
                        <h2 className={`text-3xl md:text-4xl font-extrabold mb-4 tracking-wide ${darkTheme ? 'text-white' : 'text-[#7c5dc7]'}`}>Why Email Marketing & Automation?</h2>
                        <p className={`text-lg mb-4 text-justify ${darkTheme ? 'text-white' : 'text-[#232136]'}`}>Email marketing delivers your message directly to your audience’s inbox. Automation ensures the right message reaches the right person at the right time—every time.</p>
                        <ul className={`list-disc pl-6 space-y-2 text-justify ${darkTheme ? 'text-white' : 'text-[#232136]'}`}>
                            ...
                            <li>Deliver targeted messages based on user behavior</li>
                            <li>Boost customer retention with timely offers</li>
                            <li>Reduce manual workload and save valuable time</li>
                        </ul>
                    </div>
                </div>
            </section>
            ...
            <section className={`w-full py-16 flex flex-col items-center ${darkTheme ? 'bg-black' : 'bg-white'}`}>
                <h2 className={`text-3xl md:text-4xl font-extrabold mb-10 tracking-wide text-center ${darkTheme ? 'text-white' : 'text-[#7c3aed]'}`}>Email Marketing & Automation Benefits</h2>
                <div className="w-full max-w-7xl flex flex-col md:flex-row items-center gap-12 px-4">
                    ...
                    <div className="md:w-1/2 w-full grid grid-cols-1 md:grid-cols-2 gap-8 order-1 md:order-1">
                        ...
                        <div className={`${darkTheme ? 'bg-[#232136] text-white' : 'bg-white text-[#7c3aed]'} rounded-tr-3xl rounded-bl-[60px] p-6 shadow-lg`}>
                            <h3 className={`font-bold text-lg mb-2 ${darkTheme ? 'text-white' : 'text-[#7c3aed]'}`}>Automated Workflows</h3>
                        ...
                        <div className={`${darkTheme ? 'bg-[#232136] text-white' : 'bg-white text-[#7c3aed]'} rounded-bl-3xl rounded-tr-[60px] p-6 shadow-lg`}>
                            <h3 className={`font-bold text-lg mb-2 ${darkTheme ? 'text-white' : 'text-[#7c3aed]'}`}>Higher Engagement</h3>
            ...
            <section className={`w-full py-16 flex flex-col items-center ${darkTheme ? 'bg-black' : 'bg-white'}`}>
                <div className="w-full max-w-3xl mx-auto text-center">
                    <h2 className={`text-3xl md:text-4xl font-extrabold mb-4 ${darkTheme ? 'text-white' : 'text-[#7c3aed]'}`}>Ready to Grow with Email Marketing?</h2>
                    <p className={`text-lg mb-8 ${darkTheme ? 'text-white' : 'text-[#6d28d9]'}`}>Let our email marketing experts help you nurture leads and grow your business. Contact us today for a free strategy session!</p>
